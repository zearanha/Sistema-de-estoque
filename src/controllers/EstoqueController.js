...
class EstoqueController {
    ...
    static criar(req, res) {
        ...
        EstoqueModel.criar({ nome_produto, preco, imagem }, (err, results) => {
            if (err) return res.status(500).send("Erro ao criar produto");
            res.status(201).json({ id: results.insertId, nome_produto, preco, imagem });
        });
    }
    ...
    static atualizar(req, res) {
        ...
        EstoqueModel.atualizar(id, { nome_produto, preco, imagem }, (err, results) => {
